...
import Notifications from "../extras/components/Notifications";
import ScoreCurrent from "../extras/components/ScoreCurrent";
import {
  getTimeActiveToken,
  timeExpireToken,
} from "../../../../app/common/components/apiConfig";
...
export function Topbar() {
  ...
  return (
    <div className="d-flex ">
      {user && <SearchDropdown />}
      {/*<Telegram />*/}
      {/*<ul className="sticky-toolbar nav        d-flex">*/}
      {/*  <ul/>*/}
      ...
      {user ? (
        ...
        <>
          <div className="topbar-item">
            <Link
              className="btn btn-hover-transparent-white btn-lg colorBlack p-1"
              to="/auth/login"
            >
              ورود / ثبت نام
            </Link>
