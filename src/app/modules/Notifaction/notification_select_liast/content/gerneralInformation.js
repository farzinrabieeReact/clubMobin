...
export default function GerneralInformation({ dataWeb, dataEmail, dataSms,setStateWeb ,setStateEmail,setStateSms,}) {
    ...
    <div>
      ...
      <TabPanel value={valueTab} index={0} onClick={() => {}}>
        <div className={"mt-5 position-relative"}>
          ...
          <div>
            ...
            {dataWeb.length !== 0 && <TableWeb data={dataWeb} setStateWeb={setStateWeb}/>}
      ...
      <TabPanel value={valueTab} index={1}>
        <div className={"mt-5 position-relative"}>
          ...
          <div>
            <hr className={classes["line"]} />
            {dataSms.length !== 0 && <TableSms data={dataSms} setStateSms={setStateSms}/>}
      ...
      <TabPanel value={valueTab} index={2}>
        <div className={"mt-5 position-relative"}>
          ...
          <div>
            <hr className={classes["line"]} />
            {dataEmail.length !== 0 && <TableEmail data={dataEmail} setStateEmail={setStateEmail}/>}
