        ...
        <Fade in={open}>
          <div className={classes.paper}>
            <h3 id="transition-modal-title">
              {" "}
              {reservedPlan && !reservePlan && "تمدید اشتراک"}
              {!reservePlan && !reservedPlan && "خرید اشتراک"}
            </h3>
            <p className="mt-4 me-4" style={{ fontSize: 15, color: "grey" }}>
              {reservedPlan && !reservePlan && "آیا برای تمدید مطمئن هستید؟"}
              {!reservePlan && !reservedPlan && "آیا برای خرید مطمئن هستید؟"}
            </p>
